...
export default function NoMatch() {
  return (
    <div className="h-[calc(100vh-140px)] flex flex-col items-center justify-center text-center px-4">
      <h1 className="text-8xl md:text-9xl font-bold text-accent dark:text-accent-dark opacity-80">
        404
      </h1>
      ...
      <Link
        to="/"
        className="px-6 py-3 rounded-lg bg-accent dark:bg-accent-dark text-white font-bold
